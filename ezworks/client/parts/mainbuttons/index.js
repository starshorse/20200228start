...
// inital menu default. 
	...
	if( $scope.frame_type == 'workspace' ){	
		$scope.menuList.push( $scope.create_menuEntry( 'row_add', '새로고침',{ 'click': $scope.row_add }, null ) )
...
.controller('myMainbtnCtrl',['$scope','$injector','spreadjsFilter_service','mainButtons_service','workSpaceCollections_service', 
	'spreadJs_service','workSpace_service','sheetLock_service',
	function($scope,$injector, spreadjsFilter_service, mainButtons_service, workSpaceCollections_service , spreadJs_service ,
	workSpace_service, sheetLock_service ){
...
.directive('myMainbtn', function(){
	return{
		restrict:'E',
		templateUrl:'/parts/mainbuttons/mainbtn.html',
