...
//  let ActiveSheetChanging =   SpreadJs_product( wijmoSpreadjs_factory ).Events.ActiveSheetChanging()  		
		...
		spread.bind(spreadjs_product.Events.ActiveSheetChanging, ( sender, args )=>{
		    ...
		    let newSheet_name = args.newSheet.name() 
			switch( newSheet_name ){
				case 'tbl_maker_price_result':
					ezch_tbl_maker_service.tbl_maker_price_result_init( args.newSheet ) 
					break;
				case 'tbl_maker_product_result':
					ezch_tbl_maker_service.tbl_maker_product_result_init( args.newSheet ) 
					break;
				case 'TblView':
//man					ezch_tbl_editor_appService.updateData_2( spreadjs_product , spreadJs_factory, sheetFormat_service ) 
					break;
				default:
			}
...
//temp			let headInfos = spreadJs_service.getHeadInfos4Tbl()
...
///////////////////////////////////////////////////////////////////////////////////////////////////////			
	this.register_sheet2_bind_EditEnd = ()=>{
		...
		sheet2.bind( spreadjs_product.Events.EditEnd, ( sender, args )=>{
			console.log( args ) 
//			setTimeout( update_order , 1000, args.row , args.col ) 
		})
	}
}])
