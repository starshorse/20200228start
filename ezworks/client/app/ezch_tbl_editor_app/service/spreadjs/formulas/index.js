...
.factory('formulas_factory',['$injector','row_limit',function( $injector , row_limit ){
   var asyncJob_promise_service = $injector.get('asyncJob_promise_service') 	
	var formulas_factory = {
		...
		applyFormulas : ( spreadJs_service ,row_start )=>{
...
//		var last_row = 0 
		...
		this.applyFormulas = ( spreadJs_service , row_start = 0  )=>{
			formulas_factory.applyFormulas( spreadJs_service ,row_start ) 
		}
