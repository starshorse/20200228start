 ...
 */
var myControllerModule = angular.module('viewModule', [
'ngRoute',
'ngCookies',	
'myServiceModule'
]);

myControllerModule.controller('viewCtrl', ['$scope', '$routeParams','$location','$injector','myGlobalDataService','myHttpService',
    function($scope, $routeParams,$location, $injector, myGlobalDataService, myHttpService) {
