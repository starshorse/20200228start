<template>
  <div class="componentContainer gc-scrollbar" >
    ...
    <div class="test-btn-list">
      <label >
        <input type="checkbox" :checked="showRowOutline" @click="showRowOutline = !showRowOutline"/>행 개요 표시
      </label>
      <label >
        <input type="checkbox" :checked="showColumnOutline" @click="showColumnOutline = !showColumnOutline"/>열 개요 표시
      </label>
    </div>
