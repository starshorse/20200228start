...
function initSpread() {
    ...
    sheet.setValue(2, 1, "이 샘플은 SpreadJS로 만들어졌습니다. Microsoft Excel에서 볼 수 있는 기능과 UI를 구현하였습니다. 이 샘플은 SpreadJS에서 사용할 수 있는 기능과 확장성을 보여주기 위해 구축되었습니다.");
    sheet.getRange(2, 1, 1, 12).hAlign(0).vAlign(2).wordWrap(true);
    sheet.setValue(4, 1, "샘플 사용하기");
    sheet.getRange(4, 1, 1, 12).borderBottom(border).foreColor("Text 1").hAlign(0).font("29.3333px Calibri");
    sheet.setValue(5, 1, "- 파일 메뉴에서 “새로 만들기”를 선택하여 새로운 워크북을 작성할 수 있습니다.");
    sheet.setValue(6, 1, "- 이 샘플은 SpreadJS에서 사용할 수 있는 .SSJSON 혹은 .XLSX 파일을 저장하고 불러옵니다.");
    sheet.resumePaint()
