...
FILE_NAME="runTest.js"

echo "[INFO] Creating $FILE_NAME ..."
...
echo "[INFO] Installing dependencies: express, zombie..."
npm install express zombie

echo "[INFO] Starting test script..."
node $FILE_NAME
