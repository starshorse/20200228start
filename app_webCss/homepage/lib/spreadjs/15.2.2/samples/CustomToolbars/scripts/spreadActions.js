        ...
        (function (Sheets) {
            ...
            (function (designer) {
                (function (spreadActions) {
                    ...
                    //#endregion
                    //#region CellType
                    var commands_setHyperlink = {
                        canUndo: true,
                        execute: function (context, options, isUndo) {
                            var cmd = new SetHyperlinkAction(options.spread);
                            return cmd.execute(context, options, isUndo);
                        }
                    };

                    function setHyperlink(spread, value) {
                        var sheetName = spread.getActiveSheet().name();
                        runCommand(spread, "setHyperlink", commands_setHyperlink, {
                            sheetName: sheetName,
                            value: value,
                            spread: spread
                        });
                    ...
                    spreadActions.setHyperlink = setHyperlink;

                    var SetHyperlinkAction = (function (_super) {
                        __extends(SetHyperlinkAction, _super);
                        function SetHyperlinkAction(spread) {
                            _super.call(this, spread);
                        }

                        SetHyperlinkAction.prototype.executeImp = function (context, options, isUndo) {
                            var self = this;
                            options._selections = options._selections || self._selections;
                            self.execInSelections(self._sheet, "hyperlink", function (sheet, row, column) {
                                sheet.setHyperlink(row, column, options.value);
                            }, options._selections);
                        };
                        return SetHyperlinkAction;
                    })(DesignerActionBase);
