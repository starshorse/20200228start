<template>
  <div class="navigationBar">
    ...
    <nav>
      <ul>
        <li><router-link exact to="/QuickStart">QuickStart</router-link></li>
        ...
        <li><router-link exact to="/DataBinding">Data Binding</router-link></li>
        <li><router-link exact to="/SpreadStyle">Style</router-link></li>
        <li><router-link exact to="/OutLine">Outline</router-link></li>
