...
#  current dir 
#  20200228start/python_ex/apps/codeFApi
def cert_manager( u_date = '2023-09', company ='ezchemtech' , id ='001'):
    TARGET_DIR_CERT = os.path.normpath( os.path.join( BASE_DIR,f'../../../ezworks/server/python/app/codeFApi/NPKI/{ company }/{ id }/{ u_date }/signCert.der' ))
    TARGET_DIR_KEY = os.path.normpath( os.path.join( BASE_DIR,f'../../../ezworks/server/python/app/codeFApi/NPKI/{ company }/{ id }/{ u_date }/signPri.key' ))
    """
