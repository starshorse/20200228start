angular.module('myOptsel1',[])
.controller('myOptsel1Ctrl', ['$scope', function($scope){
	init_Optsel1( $scope.spread, $scope.spread_data )
}])
.directive('myOptsel1', function(){
	return {
		restrict:'E',
		templateUrl:'/ezworks/sub_app/buynsell/parts/optsel.html',
		controller:'myOptsel1Ctrl'
	}
})
const init_Optsel1 = (spread, spread_data)=>{
