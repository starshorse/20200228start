...
.service('mySheet0Service',function(){
	const myId = 0 
	this.getSheetHeaderData = ()=>{
		return Sellin_colInfos
	}
	this.getSheetData = ()=>{
		return Sellin
	}
	this.getSheetHeaderData_arr = ( arr )=>{
		arr[myId] = this.getSheetHeaderData
	}
	this.getSheetData_arr = ( arr )=>{
		arr[myId] = this.getSheetData
	}
